package com.takisoft.datetimepicker.sample.SweetAlert;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private SweetAlertDialog setTitleText(String text) {
        mTitleText = text;
    ...
    private SweetAlertDialog setConfirmText(String text) {
        mConfirmText = text;
